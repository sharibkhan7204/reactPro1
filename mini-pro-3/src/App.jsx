        ...
        >
          {task.map(function (elem, idx) {
            return (
              <div
                key={idx}
                className="relative h-52 w-40 rounded-2xl py-8 px-4 bg-[url('https://static.vecteezy.com/system/resources/previews/037/152/677/non_2x/sticky-note-paper-background-free-png.png')] bg-cover text-black p-4"
              >
                <h2
                  onClick={() => {
                    deleteNote(idx);
                  }}
                  className="absolute active:scale-110 top-5 right-2 bg-red-500 p-1 text-xs rounded-full "
                >
                  <X size={16} strokeWidth={2.75} />
                </h2>
                <h3 className="leading-tight text-xl font-bold mt-2 ">
                  {elem.title}
                </h3>
